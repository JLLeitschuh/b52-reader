...
/**
 * Unit tests for the {@link ConfigurationV2} class.
 */
public class ConfigurationV2Test {
    ...
    public void testInitializeOnlySourceIds() throws IOException {
        ...
        ConfigurationV2 configuration = new ConfigurationV2(new ByteArrayInputStream(configurationLinesBytes));
    ...
    public void testInitializeWithException() {
        ...
        try {
            configuration = new ConfigurationV2(mockConfigurationInputStream);
        } catch (IOException e) {
